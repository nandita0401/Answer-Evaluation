	...
	<div class="card-header">
		<div class="row">
			...
			<div class="col-md-3" align="right">
				<button type="button" id="add_button" class="btn btn-info btn-sm" style="background:#5C55A6;">Add</button>
			</div>
		</div>
	</div>
	<div class="card-body">
			...
			<table id="exam_data_table" class="table table-bordered table-striped table-hover">
				<thead>
					<tr>
						...
						<th>Minimum length of the answer</th>
						<th>Status</th>
						<th>Enroll</th>
						<th>Question</th>
						<th>Result</th>
  	...
  	<div class="modal-dialog modal-lg">
    	<form method="post" id="exam_form">
      		<div class="modal-content">
      			<!-- Modal Header -->
        		<div class="modal-header"style="background: #CBC1EB;box-shadow: 3px 8px 22px rgba(94,28,68,0.15); text-align: center; font-weight: bold;">
          			<h4 class="modal-title" id="modal_title"></h4>
          			<button type="button" class="close" data-dismiss="modal">&times;</button>
        		</div>

        		<!-- Modal body -->
        		<div class="modal-body"style="background: linear-gradient(45deg, #CB88E5, #CBC1EB); box-shadow: 3px 8px 22px rgba(94,28,68,0.15);">
          			...
          			<div class="form-group">
            			<div class="row">
              				<label class="col-md-4 text-right">Number of keywords<span class="text-danger">*</span></label>
	              			<div class="col-md-8">
          			...
          			<div class="form-group">
            			<div class="row">
              				<label class="col-md-4 text-right">Minimum length of the answer<span class="text-danger">*</span></label>
	              			<div class="col-md-8">
	        	...
	        	<!-- Modal footer -->
	        	<div class="modal-footer"style="background: linear-gradient(45deg, #CB88E5, #CBC1EB); box-shadow: 3px 8px 22px rgba(94,28,68,0.15);">
	        		...
	        		<input type="submit" name="button_action" id="button_action" class="btn btn-success btn-sm" style="background:#5C55A6;" value="Add" />

	          		<button type="button" class="btn btn-danger btn-sm" data-dismiss="modal" style="background:#5C55A6;">Close</button>
	        	</div>
        	</div>
    	</form>
  	</div>
...
<div class="modal" id="deleteModal">
  	<div class="modal-dialog">
    	<div class="modal-content">
      		...
      		<!-- Modal footer -->
      		<div class="modal-footer" style="background: linear-gradient(45deg, #CB88E5, #CBC1EB); box-shadow: 3px 8px 22px rgba(94,28,68,0.15);">
      			<button type="button" name="ok_button" id="ok_button" class="btn btn-primary btn-sm" style="background:#5C55A6;">OK</button>
        		<button type="button" class="btn btn-danger btn-sm" data-dismiss="modal" style="background:#5C55A6;">Close</button>
      		</div>
    	</div>
  	</div>
    	...
    	<form method="post" id="question_form">
      		<div class="modal-content">
        		...
        		<div class="modal-body" style="background: linear-gradient(45deg, #CB88E5, #CBC1EB); box-shadow: 3px 8px 22px rgba(94,28,68,0.15);">
          			...
          			<div class="form-group">
            			<div class="row">
              				<label class="col-md-4 text-right">Keywords<span class="text-danger">*</span></label>
	              			<div class="col-md-8">
	        	...
	        	<div class="modal-footer" style="background: linear-gradient(45deg, #CB88E5, #CBC1EB); box-shadow: 3px 8px 22px rgba(94,28,68,0.15);">
	        		...
	        		<input type="hidden" name="action" style="background:#5C55A6;" id="hidden_action" value="Add" />

	        		<input type="submit" name="question_button_action" id="question_button_action" style="background:#5C55A6;" class="btn btn-success btn-sm" value="Add" />

	          		<button type="button" class="btn btn-danger btn-sm" style="background:#5C55A6;" data-dismiss="modal">Close</button>
	        	</div>
        	</div>
    	</form>
  	</div>
